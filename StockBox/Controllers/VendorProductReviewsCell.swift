//
//  VendorProductReviewsCell.swift
//  StockBox
//
...
class VendorProductReviewsCell: UITableViewCell {
    @IBDesignable class RatingControl: UIStackView {
        ...
        private func setupButtons() {
            ...
            for index in 0..<starCount {
                ...
                } else { // when not enabled for editing display current selected state for highlights
